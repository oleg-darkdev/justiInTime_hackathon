		...
		<div class="grid gap-6 md:grid-cols-2 xl:gap-x-12">
			{#each team as member}
				<div class="mb-6 lg:mb-0">
					<div
						class="relative block rounded-lg bg-white p-6 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)]"
					>
						<div class="flex-row items-center lg:flex">
							...
							<div class="w-full shrink-0 grow-0 basis-auto lg:w-7/12">
								<h5 class="mb-2 text-5xl font-bold text-violet-600">{member.title}</h5>
								<p class="mb-4 text-neutral-500">{member.desc}</p>
								<ul class="mx-auto flex list-inside justify-center lg:justify-start">
									<a href={member.github} class="px-2">
										<!-- GitHub -->
										<svg
											xmlns="http://www.w3.org/2000/svg"
											viewBox="0 0 24 24"
											class="h-20 w-20 text-violet-500"
										>
											<path
												fill="currentColor"
